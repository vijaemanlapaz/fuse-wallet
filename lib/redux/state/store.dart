...
import 'package:seedbed/redux/reducers/app_reducer.dart';
import 'package:seedbed/redux/state/state_secure_storage.dart';
import 'package:seedbed/utils/phone.dart';
import 'package:seedbed/utils/jwt.dart';
      ...
      try {
        ...
        if (initialState?.userState?.jwtToken != '') {
          ...
          if (diff.inDays <= 1) {
            ...
            jwtToken = await api.login(token.token, initialState.userState.accountAddress, initialState.userState.identifier, appName: 'Seedbed');
          }
